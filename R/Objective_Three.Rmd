...
fig <- chordDiagramFromMatrix(small_matrix, grid.col = grid.cols)
title("A. disciplines", font.main = 1, cex.main = 1.2)
#circos.par()
...
title("B. authors' countries", font.main = 1, cex.main = 1.2)
...
fullmap %>% 
  ...
  scale_fill_viridis(option = "mako", direction = -1, name = "Article count", 
      guide = guide_colorbar(direction = "horizontal")) +
  guides(fill = guide_colourbar(barwidth = unit(15, units = "mm"), barheight = unit(2, units = "mm")))
