...
Fig7b <- ggplot(count_transmission, aes(y = discipline_code, x = transmission_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
Fig7c <- ggplot(count_terminology, aes(x = reorder(terminology_code, -n), y = discipline_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
Fig7d <- ggplot(count_F0_env, aes(y = discipline_code, x = F0_env_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
