...
```{r}
Fig4 <- ((Fig4a | Fig4b | Fig4c | Fig4d) / (Fig4e | Fig4f | Fig4g | Fig4h)) + plot_annotation(tag_levels = "A")
...
## Figure five - discipline specific research patterns {.tabset}
...
Fig5a <- ggplot(count_inter_vs_trans, aes(x = discipline_code, y = inter_vs_trans_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "Discipline", y = "Inter- vs trans-inheritance", fill = "Count") + 
...
Fig5b <- ggplot(count_transmission, aes(x = discipline_code, y = transmission_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "Discipline", y = "Transmission mode", fill = "Count") + 
  geom_text(aes(label = n)) + 
  scale_fill_gradient(low = "gray80", high = "gray20")
...
### Fig. 5C - Terminology match vs mismatch
...
Fig5c <- ggplot(count_terminology, aes(y = reorder(terminology_code, -n), discipline_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "Discipline", y = "Terminology use matches Fig. 1", fill = "Count") + 
  geom_text(aes(label = n)) + 
  scale_fill_gradient(low = "gray80", high = "gray20")
...
Fig5d <- ggplot(count_F0_env, aes(x = discipline_code, y = F0_env_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "Discipline", y = "Type of environmental exposure", fill = "Count") + 
  geom_text(aes(label = n)) + 
  scale_fill_gradient(low = "gray80", high = "gray20")
...
Fig5e <- ggplot(count_exposure_timing, aes(x = discipline_code, y = exposure_timing_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "Discipline", y = "Timing of F0 (ancestor) exposure", fill = "Count") + 
  geom_text(aes(label = n)) + 
  scale_fill_gradient(low = "gray80", high = "gray20")
...
Fig5f <- ggplot(count_descendant_trait, aes(x = discipline_code, y = descendant_trait_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "Discipline", y = "Descendant traits", fill = "Count") + 
  geom_text(aes(label = n)) + 
  scale_fill_gradient(low = "gray80", high = "gray20")

Fig5f
```
### Fig. 5E - Descendant sex
...
Fig5g <- ggplot(count_descendant_sex, aes(x = discipline_code, y = descendant_sex_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "Discipline", y = "Descendant sex", fill = "Count") + 
  geom_text(aes(label = n)) + 
  scale_fill_gradient(low = "gray80", high = "gray20")
...
Fig5h <- ggplot(count_env_eff, aes(x = discipline_code, y = env_eff_direction_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(x = "Discipline", y = "Environmental effect direction", fill = "Count") + 
  geom_text(aes(label = n)) + 
  scale_fill_gradient(low = "gray80", high = "gray20")
...
Fig5 <- ((Fig5a | Fig5b | Fig5c | Fig5d) / (Fig5e | Fig5f | Fig5f | Fig5h)) + plot_annotation(tag_levels = "A")
