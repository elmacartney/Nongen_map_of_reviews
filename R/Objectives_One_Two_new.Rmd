...
Fig5b <- ggplot(percent_transmission, aes(x = reorder(transmission_code, -percent), y = percent)) + 
  geom_col(aes(), width = 0.7) +
  coord_flip() + 
  labs(y = "Percent (%)") +
  ylim(0,100) +
...
Fig5c <- ggplot(percent_terminology, aes(x =reorder(terminology_code, -percent), y = percent)) + 
  coord_flip() + 
  geom_col(aes(), width = 0.7) + 
...
Fig5d <- ggplot(percent_F0_env, aes(x = reorder(F0_env_code, -percent), y = percent)) + 
  geom_col(aes(), width = 0.7) +
  coord_flip() + 
...
count_taxa <- Merged_taxa %>% count(broad_taxa, by = discipline_code ) %>% arrange(desc(n))
...
Fig6b <- ggplot(count_taxa, aes(x = broad_taxa, y = n, fill = discipline_code)) +
...
Fig7a <- ggplot(count_inter_vs_trans, aes(x = discipline_code, y = inter_vs_trans_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
Fig7b <- ggplot(count_transmission, aes(x = discipline_code, y = transmission_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
### Fig. 7C - Terminology match vs mismatch
...
Fig7c <- ggplot(count_terminology, aes(y = reorder(terminology_code, -n), discipline_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
Fig7d <- ggplot(count_F0_env, aes(x = discipline_code, y = F0_env_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
Fig7e <- ggplot(count_exposure_timing, aes(x = discipline_code, y = exposure_timing_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
Fig7f <- ggplot(count_descendant_trait, aes(x = discipline_code, y = descendant_trait_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
Fig7g <- ggplot(count_descendant_sex, aes(x = discipline_code, y = descendant_sex_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
Fig7h <- ggplot(count_env_eff, aes(x = discipline_code, y = env_eff_direction_code, fill = n)) +
  geom_raster() + 
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
