...
# #bibliometric data
# bib <- convert2df("./Data/bibliometric2.bib", dbsource = "scopus", format = "bibtex")

bib <- convert2df(here("Data", "bibliometric2.bib"), dbsource = "scopus", format = "bibtex")

# mytree <- read.tree(file = "./Data/species_tree.tre") #if you need to read the tree
```

``` {r splitting sheets, results = 'hide'}
...
#logging n
# sample_data4$n_logged <- log10(sample_data4$n)
