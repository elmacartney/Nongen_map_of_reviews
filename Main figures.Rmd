...
### Fig. XA - Average scores across SRs
...
FigXa <- ggplot(data = percent_ceesat_score, x = question, y = percent) +
...
### Fig. XB - Individual scores

``` {r}

FigXb <- ggplot(data = ceesat_long, aes(y = id, x = question)) +
...
```{r}
FigX <- (FigXa + FigXb) + plot_annotation(tag_levels = "A")
